		...
		<div class="card-body">
			...
			<div class="d-none d-md-block">
				...
				<c:if test="${pageBean.currentPage != 1}">
    				<li class="page-item">
        			<a href="${root}board/main?board_info_idx=${board_info_idx}&page=1" class="page-link">맨 처음</a>
    				</li>
				</c:if>
				    <c:choose>
					...
					<c:if test="${pageBean.currentPage != pageBean.lastPage}">
    					<li class="page-item">
        				<a href="${root}board/main?board_info_idx=${board_info_idx}&page=${pageBean.lastPage}" class="page-link">맨 끝</a>
    					</li>
					</c:if>
				</ul>
			</div>
